...
/**
 ...
 Valid for all state.
 */
@property (nonatomic, copy, nullable) NSArray *normalAssets;
@property (nonatomic, copy, nullable) NSArray *highlightAssets;
@property (nonatomic, copy, nullable) NSArray *selectedAssets;
...
/**
 ...
 Valid for all state.
 */
@property (nonatomic, strong) id normalAsset;       // default is nil.
@property (nonatomic, strong) id selectedAsset;     // default is nil.
@property (nonatomic, strong) id highlightAsset;    // default is gray.
